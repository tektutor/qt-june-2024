...
struct qt_meta_stringdata_CLASSTabDlgENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTabDlgENDCLASS = QtMocHelpers::stringData(
    "TabDlg",
    "startThread",
    "",
    "stopThread",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTabDlgENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TabDlg::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTabDlgENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTabDlgENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTabDlgENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TabDlg, std::true_type>,
        // method 'startThread'
...
void *TabDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTabDlgENDCLASS.stringdata0))
